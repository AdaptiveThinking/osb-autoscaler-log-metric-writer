...
public class PerformanceTests {
	...
	private final static String IP = "217.26.224.222";
	private final static int PORT = 8086;
	private final static String USERNAME = "evoila";
	private final static String PASSWORD = "evoila";
	private final static String RETENTION_POLICY = "autogen";

	@Before
	public void setUp() {
		this.influxDB = InfluxDBFactory.connect("http://" + IP + ":" + PORT, USERNAME, PASSWORD);
